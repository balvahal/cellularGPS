classdef cellularGPSTrackingManual_object_control < handle
    ...
    methods
        ...
        function obj = cellularGPSTrackingManual_object_control(tmn)
            ...
            uicontrol('Parent',tabMakeCell_panel,'Style','text','Units','characters','String','do nothing',...
            ...
            uicontrol('Parent',tabMakeCell_panel,'Style','text','Units','characters','String','Join two tracks',...
                'FontSize',10,'FontName','Verdana','BackgroundColor',textBackgroundColorRegion1,...
            ...
            uicontrol('Parent',tabMakeCell_panel,'Style','text','Units','characters','String','divide a track into two',...
                'FontSize',10,'FontName','Verdana','BackgroundColor',textBackgroundColorRegion1,...
...
%             
            ...
            uicontrol('Parent',tabMakeCell_panel,'Style','text','Units','characters','String','Create a new cell',...
                'FontSize',10,'FontName','Verdana','BackgroundColor',textBackgroundColorRegion2,...
                'Position',[hx, buttonSize(2)+1, buttonSize(1),2.6923],...
                'ForegroundColor',textColor);
            
            tabMakeCell_pushbuttonAddTrack2Cell = uicontrol('Parent',tabMakeCell_panel,'Style','pushbutton','Units','characters',...
            ...
            uicontrol('Parent',tabMakeCell_panel,'Style','text','Units','characters','String','Add a track to a cell',...
                'FontSize',10,'FontName','Verdana','BackgroundColor',textBackgroundColorRegion2,...
            ...
            uicontrol('Parent',tabMakeCell_panel,'Style','text','Units','characters','String','choose mother cell',...
                'FontSize',10,'FontName','Verdana','BackgroundColor',textBackgroundColorRegion2,...
