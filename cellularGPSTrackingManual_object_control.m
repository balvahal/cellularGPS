classdef cellularGPSTrackingManual_object_control < handle
    ...
    methods
        ...
        function obj = cellularGPSTrackingManual_object_control(tmn)
            ...
            %%
            %
            tabMakeCell_panel = uipanel('Title','Track','Units','characters','Parent',tabMakeCell,...
            ...
            uicontrol('Parent',tabMakeCell_panel,'Style','text','Units','characters','String','do (n)othing',...
                'FontSize',10,'FontName','Verdana','BackgroundColor',textBackgroundColorRegion1,...
                'Position',[hx, buttonSize(2)+11, buttonSize(1),2.6923],...
                'ForegroundColor',textColor);
            
            tabMakeCell_togglebuttonJoin = uicontrol('Parent',tabMakeCell_buttongroup,'Style','togglebutton','Units','characters',...
                'FontSize',14,'FontName','Verdana','BackgroundColor',buttonBackgroundColorRegion1,...
                'String','Join',...
                'Position',[hx + buttongap + buttonSize(1), 10.5, buttonSize(1),buttonSize(2)],...
                'ForegroundColor',textColor);
            
            uicontrol('Parent',tabMakeCell_panel,'Style','text','Units','characters','String','(j)oin two tracks',...
                'FontSize',10,'FontName','Verdana','BackgroundColor',textBackgroundColorRegion1,...
                'Position',[hx + buttongap + buttonSize(1),buttonSize(2)+11, buttonSize(1),2.6923],...
                'ForegroundColor',textColor);
            
            tabMakeCell_togglebuttonBreak = uicontrol('Parent',tabMakeCell_buttongroup,'Style','togglebutton','Units','characters',...
                'FontSize',14,'FontName','Verdana','BackgroundColor',buttonBackgroundColorRegion1,...
                'String','Break',...
                'Position',[hx + buttongap*2 + buttonSize(1)*2,10.5, buttonSize(1),buttonSize(2)],...
                'ForegroundColor',textColor);
            
            uicontrol('Parent',tabMakeCell_panel,'Style','text','Units','characters','String','(b)reak a track into two',...
                'FontSize',10,'FontName','Verdana','BackgroundColor',textBackgroundColorRegion1,...
                'Position',[hx + buttongap*2 + buttonSize(1)*2, buttonSize(2)+11, buttonSize(1),2.6923],...
                'ForegroundColor',textColor);
            
            tabMakeCell_togglebuttonDelete = uicontrol('Parent',tabMakeCell_buttongroup,'Style','togglebutton','Units','characters',...
                'FontSize',14,'FontName','Verdana','BackgroundColor',buttonBackgroundColorRegion1,...
                'String','Delete',...
                'Position',[hx + buttongap*3 + buttonSize(1)*3,10.5, buttonSize(1),buttonSize(2)],...
                'ForegroundColor',textColor);
            
            uicontrol('Parent',tabMakeCell_panel,'Style','text','Units','characters','String','delete a track (-)',...
                'FontSize',10,'FontName','Verdana','BackgroundColor',textBackgroundColorRegion1,...
                'Position',[hx + buttongap*3 + buttonSize(1)*3, buttonSize(2)+11, buttonSize(1),2.6923],...
                'ForegroundColor',textColor);
            %%
            %
            buttonSize = [20 3.0769]; %[100/ppChar(3) 40/ppChar(4)];
            ...
            uicontrol('Parent',tabMakeCell_panel,'Style','text','Units','characters','String','(c)reate a new cell',...
                'FontSize',10,'FontName','Verdana','BackgroundColor',textBackgroundColorRegion2,...
                'Position',[hx, buttonSize(2)+1, buttonSize(1),2.6923],...
                'ForegroundColor',textColor);
            
            tabMakeCell_togglebuttonAddTrack2Cell = uicontrol('Parent',tabMakeCell_buttongroup,'Style','togglebutton','Units','characters',...
            ...
            uicontrol('Parent',tabMakeCell_panel,'Style','text','Units','characters','String','add a (t)rack to a cell',...
                'FontSize',10,'FontName','Verdana','BackgroundColor',textBackgroundColorRegion2,...
                'Position',[hx + buttongap + buttonSize(1),buttonSize(2)+1, buttonSize(1),2.6923],...
                'ForegroundColor',textColor);
            
            tabMakeCell_togglebuttonMother = uicontrol('Parent',tabMakeCell_buttongroup,'Style','togglebutton','Units','characters',...
                'FontSize',14,'FontName','Verdana','BackgroundColor',buttonBackgroundColorRegion2,...
                'String','Mother',...
                'Position',[hx + buttongap*2 + buttonSize(1)*2,0.5, buttonSize(1),buttonSize(2)],...
                'ForegroundColor',textColor);
            
            uicontrol('Parent',tabMakeCell_panel,'Style','text','Units','characters','String','choose (m)other cell',...
                'FontSize',10,'FontName','Verdana','BackgroundColor',textBackgroundColorRegion2,...
            ...
            handles.tabMakeCell_togglebuttonAddTrack2Cell = tabMakeCell_togglebuttonAddTrack2Cell;
        ...
        function obj = tabMakeCell_table_CellSelectionCallback(obj,~,eventdata)
            if isempty(eventdata.Indices)
                ...
                obj.tmn.mcl.pointer_makecell3 = eventdata.Indices(1,1);
                if ~isempty(obj.tmn.mcl.makecell_ind{obj.tmn.mcl.pointer_makecell})
                    obj.tmn.mcl.pointer_track2 = obj.tmn.mcl.pointer_track;
                    obj.tmn.mcl.pointer_track = obj.tmn.mcl.makecell_ind{obj.tmn.mcl.pointer_makecell}(1);
                    obj.tmn.gui_imageViewer.highlightTrack;
                end
            end
        end
        %%
        ...
        function obj = tabMakeCell_pushbuttonAddTrack2Cell_Callback(obj,~,~)
            ...
            obj.tabMakeCell_loop;
            obj.tmn.gui_imageViewer.updateTrackText;
        end
        %%
        %
