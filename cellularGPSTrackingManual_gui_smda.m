...
heditOutputDirectory = uicontrol('Style','edit','Units','characters',...
    ...
    'String',num2str(trackman.itinerary.output_directory),...
...
htableSettings = uitable('Units','characters',...
    ...
    'ColumnFormat',{transpose(trackman.mm.Channel),'numeric','numeric','numeric','numeric','numeric','numeric','numeric','numeric','numeric','char','numeric'},...
