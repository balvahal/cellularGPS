classdef cellularGPSViewer_object_control < handle
    %% Properties
    %   ___                       _   _
    ...
    methods
        ...
        %
        %
        function obj = cellularGPSViewer_object_control(tmn)
            %%%
            % parse the input
            q = inputParser;
        ...
        function obj = infoBk_editStepSize_Callback(obj,~,~)
            ...
            if indImage < 1
                obj.tmn.indImage = 1;
            elseif indImage > height(obj.tmn.smda_databaseSubset)
                obj.tmn.indImage = height(obj.tmn.smda_databaseSubset)-1;
            else
                obj.tmn.indImage = indImage;
            end
            obj.tmn.stepSize = indImage;
            handles.infoBk_editStepSize.String = num2str(obj.tmn.indImage);
            guidata(obj.gui_main,handles);
        end
        %%
        %
